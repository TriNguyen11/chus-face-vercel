...
const TextDetect = () => {
  ...
  const notify = () =>
    toast.error("Your text must be between 4-10 characters!");
  const downloadImg = () => {
    htmlToImage
      ...
      <div className="container-lg mx-auto h-screen ">
        ...
        <section className="grid sm:grid-cols-1 md:grid-cols-2 justify-around ">
          ...
          <div className="bg-white mx-auto">
            <div
              id="ImageDownload"
              className=" overflow-hidden flex flex-col justify-center items-center  col-span-7 box-content w-[43vh] h-[43vh] md:w-[48vw] md:h-[48vw] xl:w-[45vw] xl:h-[45vw] rounded-xl shadow bg-nguyen gap-4">
              {name && (
                <span
                  id="name"
